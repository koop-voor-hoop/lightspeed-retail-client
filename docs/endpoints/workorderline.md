...
title: WorkorderLine
category: Endpoints
source: https://developers.lightspeedhq.com/retail/endpoints/WorkorderLine/
---

# WorkorderLine

This endpoint has been deprecated and should be used for backwards compatibility only. New integrations should make use of the [Workorder WorkorderLine](https://developers.lightspeedhq.com/retail/endpoints/Workorder-WorkorderLine) endpoint.
...
```
GET /API/V3/Account/{accountID}/WorkorderLine.json
```
...
"https://api.lightspeedapp.com/API/V3/Account/{accountID}/WorkorderLine.json"
```
...
```
GET /API/V3/Account/{accountID}WorkorderLine/{workorderLine}.json
```
...
```shell
$ curl -H "Authorization: Bearer {Access Token}" \
"https://api.lightspeedapp.com/API/V3/Account/{accountID}/WorkorderLine/{workorderLine}.json"
```
...
| workorderLineID | (integer) The unique numerical ID for the workorder line. |
| --- | --- |

...
title: Item Image
category: Endpoints
source: https://developers.lightspeedhq.com/retail/endpoints/Item-Image/
---
...
files = {'image': ('test.jpg', open('/Users/lightspeed/testimage.jpg', 'rb'), 'image/jpeg')}
payload = {'data': '{"description": "Test Image", "filename": "test.jpg", "itemID": 2}'}
...
```php
$url = "https://api.lightspeedapp.com/API/V3/Account/{accountID}/Item/{itemID}/Image.json";
...
```
POST /API/V3/Account/{Account ID}/Item/{Item ID}/Image.json
Accept: application/json
...
--25112bca3fa7474e9874f9e8654c27aa
Content-Disposition: form-data; name="image"; filename="2021 red racer.jpg"

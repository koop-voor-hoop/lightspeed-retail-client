...
title: Image
category: Endpoints
source: https://developers.lightspeedhq.com/retail/endpoints/Image/
---
...
If you are dealing with Images that will be assigned to Item or ItemMatrix, consider using the [Item Image](https://developers.lightspeedhq.com/retail/endpoints/Item-Image/) or [ItemMatrix Image](https://developers.lightspeedhq.com/retail/endpoints/ItemMatrix-Image/) endpoints.
...
'https://api.lightspeedapp.com/API/V3/Account/{AccountID}/Image.json'
```
...
```php
$url = "https://api.lightspeedapp.com/API/V3/Account//Image.json";
...
```
POST /API/V3/Account/{ID}/Image.json
Accept: application/json
...
When uploading images to this endpoint, you must include either the itemID or the itemMatrixID.
